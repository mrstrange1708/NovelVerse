...
import { IconBook, IconSettings, IconLogout, IconTrendingUp, IconAward, IconClock, IconStar } from "@tabler/icons-react";
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    >
                        <h1 className="text-4xl md:text-5xl font-bold text-white mb-2">
                            Welcome back, <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-cyan-400">{user.firstName}</span>
                        </h1>
                        <p className="text-gray-400 text-lg">Track your reading journey and discover new books</p>
                    </motion.div>
                    ...
                    >
                        ...
                        <div className="relative flex flex-col md:flex-row items-center md:items-start gap-6">
                            ...
                            <div className="flex-1 text-center md:text-left">
                                ...
                                <p className="text-emerald-400 text-sm mb-6">Member since 2024</p>
                            ...
                            return (
                                ...
                                >
                                    <div className="flex items-start justify-between mb-4">
                                        ...
                                        <div className={`text-sm ${colors.text} font-medium px-3 py-1 ${colors.bg} rounded-full`}>
                                            Active
                                        </div>
                                    </div>
                                    <div>
                                        <p className="text-gray-400 text-sm mb-1">{stat.label}</p>
                                        <p className={`text-4xl font-bold ${colors.text} mb-1`}>{stat.value}</p>
                    ...
                    >
                        <div className="flex items-center justify-between mb-6">
                            <div>
                                ...
                                <p className="text-gray-400 text-sm">Your latest reading adventures</p>
                            </div>
                        ...
                        {recentBooks.length > 0 ? (
                                                ...
                                                <div className="flex items-start gap-3">
                                                    {book.coverImage ? (
                                                        ...
                                                        <div className="w-12 h-16 bg-gradient-to-br from-emerald-500/20 to-cyan-500/20 rounded-lg flex items-center justify-center">
                                                            <IconBook className="text-emerald-400" size={24} />
                                                        </div>
                                                    )}
                                                    <div className="flex-1 min-w-0">
                                                        ...
                                                        <p className="text-gray-400 text-sm truncate mb-2">{book.author}</p>
                                                        {book.category && (
                            ...
                            <div className="text-center py-16">
                                ...
                                <p className="text-gray-400 mb-6 max-w-md mx-auto">
                                    Start your reading journey today and discover amazing stories waiting for you!
                                </p>
                                <Link 
                                    href="/category" 
