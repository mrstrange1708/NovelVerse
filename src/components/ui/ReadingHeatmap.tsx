...
export function ReadingHeatmap({ data, year = new Date().getFullYear() }: ReadingHeatmapProps) {
    const [hoveredCell, setHoveredCell] = useState<{ date: string; pages: number } | null>(null);
    ...
    const handleMouseEnter = (date: Date, pages: number, event: React.MouseEvent) => {
        setHoveredCell({
    ...
    return (
        <div className="relative w-full">
            ...
            <div className="flex gap-3">
                ...
                <div className="flex flex-col justify-start" style={{ paddingTop: '24px' }}>
                    <div className="text-xs text-gray-500 h-[11px] flex items-center mb-[2px]">Sun</div>
                    <div className="text-xs text-gray-500 h-[11px] flex items-center mb-[2px]">Mon</div>
                    <div className="text-xs text-gray-500 h-[11px] flex items-center mb-[2px]">Tue</div>
                    <div className="text-xs text-gray-500 h-[11px] flex items-center mb-[2px]">Wed</div>
                    <div className="text-xs text-gray-500 h-[11px] flex items-center mb-[2px]">Thu</div>
                    <div className="text-xs text-gray-500 h-[11px] flex items-center mb-[2px]">Fri</div>
                    <div className="text-xs text-gray-500 h-[11px] flex items-center mb-[2px]">Sat</div>
                </div>
            ...
            {hoveredCell && (
                <div
                    className="fixed z-[9999] px-3 py-2 bg-gray-900 border border-gray-700 rounded-lg shadow-xl text-sm pointer-events-none"
                    style={{
                        left: tooltipPos.x,
                        top: tooltipPos.y,
                ...
                >
                    ...
                    <div className="text-gray-400">
                        {hoveredCell.pages} {hoveredCell.pages === 1 ? "page" : "pages"} read
                    </div>
                </div>
            )}
